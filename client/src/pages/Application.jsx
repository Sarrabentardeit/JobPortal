      ...
      <div className='container px-4 min-h-[65vh] 2xl:px-20 mx-auto my-10'>
        ...
        <div className='flex gap-2 mb-6 mt-3'>
        {
          ...
          <label className='flex items-center' htmlFor="resumeUpload">
            ...
            <input c id='resumeUpload' onChange={e => setResume(e.target.files[0])} accept='application/pdf' type="file" hidden />
...
<span className={`${job.status === 'Accepted' ? 'bg-green-100' : job.status === 'Rejected' ? 'bg-red-100' : job.status === 'Pending' ? 'bg-blue-100' : ''} px-4 py-1.5 rounded`}>
                    {job.status}
                  </span>
                </td>
              </tr>
